...
const Respuesta = ({ onBack, question }) => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-teal-50 to-teal-100">
      ...
      <div className="flex-1 p-6 bg-white rounded-xl shadow-lg mx-4 mt-6 mb-10">
        <div className="container mx-auto">
          {/* Botón de volver */}
          <button
            onClick={onBack}
            className="mb-6 inline-flex items-center gap-2 text-teal-600 hover:text-teal-800 font-medium text-lg"
          >
