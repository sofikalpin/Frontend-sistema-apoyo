...
const toggleConfirmPasswordVisibility = () => {
  ...
  if (validateStep()) {
    ...
    const usuarioData = {
      idusuario: 0, // Esto puede ser generado por el backend
      nombrecompleto: formData.name,
      correo: formData.email,
      contraseñaHash: formData.password, // Contraseña en texto plano
      ...
      tokenRecuperacion: generartetoken(), // Esto puede ser generado por el backend
