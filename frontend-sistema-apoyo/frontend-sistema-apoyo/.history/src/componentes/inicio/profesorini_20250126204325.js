    ...
    <div className="bg-gray-100 min-h-screen p-8">
      ...
      <div className="flex flex-wrap gap-4">
        {filteredTeachers.map((teacher, index) => (
          <div key={index} className="bg-white p-5 rounded-xl shadow-lg w-80 text-center">
            <div className="mb-4">
              <img
            ...
            <p className="text-sm text-gray-500">{teacher.status}</p>
            ...
            <div className="mt-4">
              <button className="text-red-500 text-3xl focus:outline-none">Me interesa</button>
            </div>
          </div>
        ))}
      </div>
