    ...
    <div className="bg-gray-100 min-h-screen p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredTeachers.map((teacher, index) => (
          <div
            key={index}
            className="bg-white p-4 rounded-lg shadow-md border border-gray-300 hover:shadow-lg transition-all duration-300 flex flex-col items-center"
          >
            <div className="bg-gray-100 p-4 rounded-lg w-full text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">{teacher.title}</p>
              <p className="text-gray-800 mb-4">{teacher.description}</p>
