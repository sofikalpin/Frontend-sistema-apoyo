...
export default function InicioProfesor() {
  ...
  {/* Filtro de niveles */}
<div className="bg-gray-200 p-4 rounded-xl shadow-lg w-full h-80 flex flex-col items-center justify-between max-w-7xl fixed right-0 mr-5">
  <select
    value={selectedLevel}
    onChange={handleLevelChange}
    className="px-6 py-3 border rounded text-xxl bg-green-500 text-white hover:bg-green-600"
