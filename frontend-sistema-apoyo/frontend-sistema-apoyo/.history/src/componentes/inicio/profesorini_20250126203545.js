        ...
        {filteredTeachers.map((teacher, index) => (
          ...
          >
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-500 text-sm">{teacher.status}</p>
              <div className="flex items-center mt-2">
                <span className="text-yellow-500 mr-2">⭐ {teacher.rating}</span>
                <span className="text-gray-500">({teacher.reviews} Opiniones)</span>
              </div>
            </div>
            {/* Descripción del profesor */}
            <div className="mt-4">
              <p className="text-gray-800">{teacher.description}</p>
              <p className="text-gray-500 mt-2">Nivel: {teacher.level}</p>
            </div>
          </div>
        ))}
      </div>
