...
const footerSections = {
  section1: {
    title: "Información",
    links: [
      { name: "Sobre Nosotros", route: "/informacion" },
      { name: "Términos y Condiciones", route: "/informacion" },
      { name: "Contacto", route: "/informacion" }
    ]
  },
  section2: {
    title: "Programas",
    links: [
      { name: "Nivel Inicial", route: "/NivelInicial" },
      { name: "Nivel Medio", route: "/NivelIntermedio" },
      { name: "Nivel Superior", route: "/NivelAvanzado" }
    ]
  }
};
