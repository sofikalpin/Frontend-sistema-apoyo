...
export default function InicioProfesor() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-8">
      ...
      {/* Selector de nivel - Movido arriba de la lista de profesores y estilizado */}
      <div className="bg-white p-4 rounded-xl shadow-lg max-w-7xl mx-auto mb-6 flex justify-end">
        <select
          value={selectedLevel}
          onChange={handleLevelChange}
          className="px-5 py-2 text-2xl border rounded w-full max-w-xs mx-auto bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
