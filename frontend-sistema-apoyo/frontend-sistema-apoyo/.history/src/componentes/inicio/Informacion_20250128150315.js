...
const Contacto = () => (
  <div className="p-8 max-w-3xl mx-auto space-y-6">
    <h1 className="text-5xl font-bold text-black-600 mb-6 text-center">Contacto</h1>

    <div className="p-8 bg-white rounded-lg shadow-xl space-y-6">
      <p className="text-lg text-gray-700 text-justify">
        ¿Tienes preguntas o comentarios? Nos encantaría saber de ti. Rellena el siguiente formulario y nuestro equipo se pondrá en contacto contigo lo antes posible.
      </p>
...
const Navigation = ({ currentPage, setCurrentPage }) => (
  <nav className="w-64 bg-gradient-to-b from-gray-200 to-gray-100 p-6">
    <div className="mb-12">
      <h2 className="text-3xl font-bold text-transparent bg-clip-text text-center bg-gradient-to-r from-blue-500 to-pink-500">
        Información
      </h2>
