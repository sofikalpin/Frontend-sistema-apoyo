  ...
  <div className="p-8 max-w-3xl mx-auto space-y-6">
    ...
    <div className="p-8 bg-white rounded-lg shadow-xl space-y-6">
      ...
      <p className="text-lg text-gray-700 text-justify mb-6">
        Bienvenido a <strong>EduMatch</strong>, una plataforma educativa para enseñar inglés en línea. Al usar nuestros servicios, aceptas estos términos y condiciones. Si no estás de acuerdo, por favor, no uses la plataforma.
      </p>

      <h2 className="text-xl font-semibold text-gray-800 mt-4">1. Aceptación de los Términos</h2>
      <p className="text-lg text-gray-700 text-justify">
        Al registrarte y usar EduMatch, aceptas cumplir con estos términos. Si no estás de acuerdo, no puedes usar la plataforma.
      </p>

      <h2 className="text-xl font-semibold text-gray-800 mt-4">2. Servicios Proporcionados</h2>
      <p className="text-lg text-gray-700 text-justify">
      ...
      <h2 className="text-xl font-semibold text-gray-800 mt-4">3. Responsabilidades del Usuario</h2>
      <p className="text-lg text-gray-700 text-justify">
      ...
      <h2 className="text-xl font-semibold text-gray-800 mt-4">4. Modificaciones a los Términos</h2>
      <p className="text-lg text-gray-700 text-justify">
      ...
      <h2 className="text-xl font-semibold text-gray-800 mt-4">5. Terminación de los Servicios</h2>
      <p className="text-lg text-gray-700 text-justify">
