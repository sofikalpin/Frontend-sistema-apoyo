...
export default function InicioProfesor() {
  ...
  {/* Filtro de niveles */}
{/* Filtro de niveles */}
<div className="bg-gray-200 p-4 rounded-xl shadow-lg w-full h-80 max-w-7xl fixed right-5 top-1/4">
  <select
    value={selectedLevel}
    onChange={handleLevelChange}
    className="px-6 py-3 border rounded text-xxl bg-green-500 text-white hover:bg-green-600 float-right"
