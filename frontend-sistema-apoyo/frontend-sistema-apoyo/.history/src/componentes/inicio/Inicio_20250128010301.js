...
export default function Inicio() {
  ...
  return (
    <div className="bg-gray-100">
      ...
      {showLoginModal && (
        <Modal title="Iniciar Sesión" onClose={handleCloseLoginModal}>
          {/* Aquí pones el formulario de inicio de sesión */}
          <form>
            {/* Ejemplo de campos */}
            <input type="text" placeholder="Correo electrónico" className="w-full p-2 my-2 border border-gray-300 rounded" />
            <input type="password" placeholder="Contraseña" className="w-full p-2 my-2 border border-gray-300 rounded" />
            <button type="submit" className="w-full py-2 bg-blue-500 text-white rounded">Iniciar Sesión</button>
          </form>
        </Modal>
      )}
      ...
      {showRegisterModal && (
        <Modal title="Registrarse" onClose={handleCloseRegisterModal}>
          {/* Aquí pones el formulario de registro */}
          <form>
            {/* Ejemplo de campos */}
            <input type="text" placeholder="Nombre completo" className="w-full p-2 my-2 border border-gray-300 rounded" />
            <input type="email" placeholder="Correo electrónico" className="w-full p-2 my-2 border border-gray-300 rounded" />
            <input type="password" placeholder="Contraseña" className="w-full p-2 my-2 border border-gray-300 rounded" />
            <button type="submit" className="w-full py-2 bg-yellow-500 text-white rounded">Registrarse</button>
          </form>
        </Modal>
      )}
