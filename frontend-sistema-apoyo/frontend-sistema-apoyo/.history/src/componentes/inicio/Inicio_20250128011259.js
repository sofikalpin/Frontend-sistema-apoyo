...
import { X, Star, Facebook, Instagram, Twitter, Youtube, Linkedin } from 'lucide-react';
import logo from '../../logo/LogoInicio.png';
import Imagen1 from './pexels-divinetechygirl-1181534.jpg';
import Imagen2 from './pexels-katerina-holmes-5905709.jpg';
import { footerSections, socialIcons } from './footerData'; // Asegúrate de que esta importación esté correcta
  ...
  return (
    <div className="bg-gray-100">
      ...
      <div className="bg-white py-2 flex justify-end items-center px-6">
        <button
          onClick={() => navigate('/IniciarSesión')}
