...
export default function InicioProfesor() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-8">
      ...
      <div className="p-4 max-w-7xl mx-auto mb-6 flex justify-end top-1/4">
      bg-gray-200 p-4 rounded-xl shadow-lg max-w-7xl fixed right-5 top-1/4 flex justify-end
        <select
          value={selectedLevel}
