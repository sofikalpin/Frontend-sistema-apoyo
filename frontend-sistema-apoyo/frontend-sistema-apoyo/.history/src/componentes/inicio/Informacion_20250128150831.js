  ...
  <div className="p-8 max-w-3xl mx-auto space-y-6">
    ...
    <div className="p-8 bg-white rounded-lg shadow-xl space-y-6">
      <p className="text-lg text-gray-700 text-justify">
        <strong>EduMatch</strong> es una aplicación web de apoyo escolar enfocada en enseñar inglés...
      </p>
      <p className="text-lg text-gray-700 text-justify">
        El nivel <strong>inicial</strong> cubre lo básico: gramática, vocabulario y pronunciación...
      </p>
      <p className="text-lg text-gray-700 text-justify">
        Lo mejor de <strong>EduMatch</strong> es que no solo cuenta con contenidos interactivos...
      </p>
      <p className="text-lg text-gray-700 text-justify">
        <strong>EduMatch</strong> es una excelente opción para quienes buscan un aprendizaje serio...
      </p>
    </div>
...
const Contacto = () => (
  <div className="p-8 max-w-3xl mx-auto space-y-6">
    ...
    <div className="p-8 bg-white rounded-lg shadow-xl space-y-6">
      <p className="text-lg text-gray-700 text-justify">
        ¿Tienes preguntas o comentarios? Nos encantaría saber de ti. Rellena el siguiente formulario...
      </p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="p-6 bg-white rounded-lg shadow-lg">
        ...
        <p className="text-lg text-gray-700 mt-4">
          Al registrarte y usar EduMatch, aceptas cumplir con estos términos...
        </p>
      </div>
      <div className="p-6 bg-white rounded-lg shadow-lg">
