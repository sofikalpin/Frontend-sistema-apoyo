...
import { iniciarSesion } from "./ApiLogin";

// Componente ForgotPassword
const ForgotPassword = ({ onClose }) => {
  // Tu código para el componente ForgotPassword permanece igual.
};
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/home'); // Aquí '/home' sería la ruta donde quieres redirigir al usuario
