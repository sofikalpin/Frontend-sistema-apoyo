  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow p-8 max-w-5xl mx-auto w-full">
        <h2 className="text-[#1B1B1B] text-2xl font-bold mb-8">Datos personales</h2>
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1">
            ...
            <div className="mt-8 flex justify-end">
              <button className="bg-blue-600 text-white px-6 py-2 rounded-full text-lg hover:bg-blue-700 transition-colors text-center">
