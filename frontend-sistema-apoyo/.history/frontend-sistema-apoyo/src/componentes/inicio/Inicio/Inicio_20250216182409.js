  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        ...
        // Validar y extraer arreglo de reseñas desde "value" si es necesario
        let reviewArray = [];
        ...
        console.log('usersData:', usersData); // Verifica la estructura de los datos

        // Extraer el arreglo de usuarios desde "value" si existe
        let userArray = [];
        ...
        // Crear un mapa de ID de usuario a nombres para búsqueda rápida
        const userMap = {};
        ...
        // Ordenar las reseñas por rating de forma descendente
