...
export const NuevoProfesor = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-xl bg-white shadow-2xl rounded-3xl overflow-hidden transform transition-all duration-300 hover:scale-[1.01]">
        {/* Header */}
        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-8 text-center relative">
          <div className="absolute left-6 top-6">
            <img src={logo} alt="Logo" className="w-20 h-20 object-contain rounded-full border-4 border-white/20" />
          </div>
          <h3 className="text-3xl font-bold text-white tracking-wide">
            Registro de Profesor
          </h3>
          <div className="absolute right-6 top-6 bg-white/10 p-2 rounded-full">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <input 
                ...
                type="text" 
                className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-300"
