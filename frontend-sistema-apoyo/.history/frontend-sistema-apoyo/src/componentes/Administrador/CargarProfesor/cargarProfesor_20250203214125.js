...
const CargarProfesor = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-100">
            ...
            <div className="flex flex-col items-center mt-8 px-10 max-w-12xl mx-auto">
            <input
    type="text"
    placeholder="Buscar por nombre de profesor..."
    value={busqueda}
    onChange={(e) => setBusqueda(e.target.value)}
    className="p-4 w-100 text-lg border border-gray-300 rounded-lg mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
    autoComplete="off"
/>
