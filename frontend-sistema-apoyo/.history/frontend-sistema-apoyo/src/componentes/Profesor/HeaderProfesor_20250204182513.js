            ...
            <nav className="flex items-center justify-between p-6 bg-teal-600 text-white">
                <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-8">
                        <Link to="/inicio" className="font-bold hover:text-yellow-400 text-xl">
                            Inicio
                        </Link>
                        <Link to="/mis-cursos" className="font-bold hover:text-yellow-400 text-xl">
                            Mis Cursos
                        </Link>
                        <Link to="/mis-alumnos" className="font-bold hover:text-yellow-400 text-xl">
                            Mis Alumnos
                        </Link>
                    </div>
