...
const CursoDetalle = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100 flex flex-col">
      ...
      {/* Contenido principal */}
      <div className="curso-detalles-container px-5 py-10 mt-16 text-center bg-[#f0faf7] flex-grow">

        <h1 className="text-5xl font-bold text-[#2c7a7b] mb-12">{curso.nombre}</h1>
