...
import ListaAlumnos from "./componentes/Administrador/Alumnos/listaAlumnos/listaAlumnos";
import EditarAlumno from "./componentes/Administrador/Alumnos/EditarAlumno/editAlumno";
import CargarProfesor from "./componentes/Administrador/Profesores/CargarProfesor/cargarProfesor";
  ...
  return (
    <div className="App">
      <Routes>
        ...
        <Route path="/administrador/nuevoAlumno" element={<NuevoAlumno />} />
