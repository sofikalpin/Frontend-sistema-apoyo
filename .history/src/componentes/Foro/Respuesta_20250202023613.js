...
const Respuesta = ({ onBack, question }) => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-grey-900 to-teal-900">
      ...
      {/* Contenido principal adaptado a toda la pantalla */}
        ...
        <button
            onClick={onBack}
            className="absolute top-3 left-6 inline-flex items-center gap-2 text-teal-600 hover:text-teal-800 font-medium text-xl z-10 "
          >
