...
const Foro = () => {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-start bg-teal-400">
      {/* HeaderForo ocupa toda la pantalla */}
      <HeaderForo />

      {/* Resto del contenido del foro */}
      ...
      <div className="w-full flex flex-col items-center p-14 space-y-14 bg-white rounded-lg shadow-md mx-4">
        ...
        <div className="w-full p-24 border-b border-gray-300 mb-5">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              <span className="bg-gray-200 rounded-full w-[30px] h-[30px] flex items-center justify-center font-bold">
                V
              </span>
        ...
        <div className="w-full p-5 border-b border-gray-300 mb-5">
          ...
          <div className="mt-3 text-left">
            ...
            <p>
              ¿En qué situaciones se usa el present perfect? Agradecería si me
              pueden dar ejemplos.
            </p>
          </div>
          <div className="mt-5 flex justify-end space-x-3">
      ...
      <button
        className="fixed bottom-8 right-8 bg-teal-claro text-white px-6 py-3 rounded-full shadow-lg hover:opacity-90 z-50"
