    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-teal-50 to-teal-100">
      ...
      <div className="flex-1 p-6">
        <div className="container mx-auto relative">
          ...
          <button
            onClick={onBack}
            className="absolute top-3 left-6 inline-flex items-center gap-2 text-teal-600 hover:text-teal-800 font-medium text-lg z-10"
          >
            <ArrowLeft className="w-5 h-5 w-8 h-8" />
