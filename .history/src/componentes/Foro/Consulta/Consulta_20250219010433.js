...
/*************  ✨ Codeium Command ⭐  *************/
/**
 * Muestra una consulta con sus respuestas.
 * 
 * Si el usuario tiene un nivel mayor o igual al nivel de la consulta, puede
 * crear una respuesta.
 * 
 * @returns {JSX.Element} La pagina de la consulta con sus respuestas.
 */
/******  75a18ac6-1997-4532-87b1-108e88a0ec4e  *******/
const Consulta = () => {
