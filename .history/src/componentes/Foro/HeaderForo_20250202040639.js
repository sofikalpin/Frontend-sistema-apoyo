...
import { useHistory } from "react-router-dom"; // Importar el hook de history
...
const Header = () => {
    ...
    const history = useHistory(); // Hook de history para navegar
    ...
    const goToProfile = () => {
        history.push("/perfil"); // Asegúrate de que "/perfil" es la ruta correcta
    };
    ...
    const handleLogout = () => {
        ...
        if (confirmLogout) {
            history.push("/"); // Redirige al inicio después de confirmar
        }
    };
