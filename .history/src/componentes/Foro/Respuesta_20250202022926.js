...
const Respuesta = ({ onBack, question }) => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-teal-50 to-teal-100">
      ...
      {/* Botón de volver, fuera del cuadro blanco */}
      <button
        onClick={onBack}
        className="absolute top-6 left-6 inline-flex items-center gap-2 text-teal-600 hover:text-teal-800 font-medium text-lg z-10"
      >
      ...
      <div className="flex-1 p-6 bg-white rounded-xl shadow-lg mx-4 mt-16 mb-10">
