...
import FooterForo from "../inicio/Componentes/Footer.js"
  ...
  useEffect(() => {
    const fetchConsultas = async () => {
      ...
      try {
        ...
        const respuesta = await axios.get(`https://backend-sistema-apoyo-production.up.railway.app/API/Foro/ConsultasForo?idForo=${foro.idforo}`)
