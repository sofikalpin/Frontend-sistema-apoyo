...
export default function Inicio() {
  ...
  return (
    <div className="bg-gray-100">
      {/* Navbar */}
      <header className="flex flex-col items-center justify-center p-6 bg-blue-900 text-white">
  {/* Botón de iniciar sesión sobre el logo */}
  <button
    onClick={() => setShowLoginModal(true)}
    className="px-4 py-2 mb-4 bg-green-500 text-white rounded-lg"
  >
    Iniciar Sesión
  </button>
...
{/* Sección de los tres pilares de aprendizaje con fondo blanco en los títulos */}
<section className="p-12 bg-gray-50" ref={cursosRef}>
  <h2 className="text-3xl font-semibold text-blue-900 mb-8 text-center bg-white py-2 px-4 rounded-md">
  ...
  <div className="flex flex-col lg:flex-row gap-8">
    ...
    <div className="lg:w-1/3 flex justify-center">
      ...
      {showLoginModal && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white rounded-lg p-8 w-96">
            <button onClick={() => setShowLoginModal(false)} className="absolute top-2 right-2 text-gray-500">
              <X size={24} />
            </button>
            ...
            <form onSubmit={handleLoginSubmit}>
              ...
              <button type="submit" className="w-full px-4 py-2 bg-green-500 text-white rounded-lg">Entrar</button>
            </form>
          </div>
        </div>
      )}
      ...
      {showRegisterModal && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white rounded-lg p-8 w-96">
            <button onClick={() => setShowRegisterModal(false)} className="absolute top-2 right-2 text-gray-500">
              <X size={24} />
            </button>
            ...
            <form onSubmit={handleRegisterSubmit}>
              ...
              <button type="submit" className="w-full px-4 py-2 bg-green-500 text-white rounded-lg">Regístrate</button>
            </form>
          </div>
        </div>
      )}
