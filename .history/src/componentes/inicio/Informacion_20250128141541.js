...
const NavItem = ({ id, Icon, text, isActive, onClick }) => (
  <div
    onClick={onClick}
    className={`flex items-center space-x-3 p-2 rounded-lg cursor-pointer ${isActive ? 'bg-blue-600 text-white' : 'text-gray-300'}`}
  >
...
const SobreNosotros = () => (
  <div>
    ...
    <p className="text-gray-400 mt-4">Información sobre la organización...</p>
  </div>
);
...
const Contacto = () => (
  <div>
    ...
    <p className="text-gray-400 mt-4">Información de contacto...</p>
  </div>
);
...
const InfoPages = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Info Content */}
      <div className="flex flex-1 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-200">
