...
// SobreNosotros component
const SobreNosotros = () => (
  <div className="p-8 bg-gradient-to-br from-blue-50 via-gray-100 to-white rounded-lg shadow-lg max-w-3xl mx-auto space-y-6">
    <h1 className="text-4xl font-extrabold text-blue-600 mb-6 text-center">Sobre EduMatch</h1>
    ...
    <div className="bg-blue-600 p-4 rounded-lg text-white text-center mt-8">
      <p className="text-lg font-semibold">¡Únete hoy y comienza tu camino hacia la certificación internacional en inglés con EduMatch!</p>
    </div>
  </div>
);
