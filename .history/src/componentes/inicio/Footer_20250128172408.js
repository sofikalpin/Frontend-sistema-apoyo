...
const UpdatedFooter = ({ socialIcons = [], footerSections = {}, navigate }) => {
  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-6xl mx-auto py-12 px-4 text-center pl-20 ">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8 justify-center pl-30">
