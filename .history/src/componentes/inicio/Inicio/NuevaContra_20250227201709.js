...
const ResetPassword = () => {
  ...
  useEffect(() => {
    ...
    // El token se guarda en el estado o puede usarse directamente en el envío
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://backend-sistema-apoyo-production.up.railway.app/API/Usuario/reestablecer-contrasena', {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center" style={{ backgroundColor: '#00A89F' }}>
      ...
      <div className="bg-white p-10 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div>
            <label htmlFor="newPassword" className="block text-lg font-medium text-gray-700">Nueva Contraseña:</label>
