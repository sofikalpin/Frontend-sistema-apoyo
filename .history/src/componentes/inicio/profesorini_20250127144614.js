...
export default function InicioProfesor() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-8">
      ...
      {/* Filtro de niveles */}
      <div className="bg-gray-200 p-4 rounded-xl shadow-lg w-full h-80 flex flex-col items-center justify-between mr-5 max-w-7xl mx-auto flex justify-between items-center">
      <select
  value={selectedLevel}
  onChange={handleLevelChange}
  className="px-6 py-6 border rounded text-xxl"
