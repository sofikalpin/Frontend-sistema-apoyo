    ...
    const handleActualizar = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(
                `https://backend-sistema-apoyo-production.up.railway.app/API/AdministradorAlumno/EditarporID?id=${idusuario}`,
                datosActualizados
            );
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 font-sans">
            <div className="w-full max-w-xl bg-white shadow-2xl rounded-3xl overflow-hidden">
                <div className="bg-[#00A89F] p-4 md:p-8 text-center relative flex flex-col items-center">
                    <img src={logo} alt="Logo" className="w-32 md:w-40 h-auto object-contain mb-2 md:mb-4" />
                    <h3 className="text-2xl md:text-3xl font-bold text-white tracking-wide">Editar Alumno</h3>
                </div>
                ...
                {loading ? (
                    ...
                    <form onSubmit={handleActualizar} className="p-4 md:p-10 space-y-4 md:space-y-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                            <div>
                                ...
                                <input 
                                    ...
                                    type="text" 
                                    className="w-full px-3 py-2 md:px-4 md:py-3 border border-gray-300 rounded-lg focus:ring-[#00A89F] focus:outline-none focus:border-[#00A89F]" 
                                />
                            </div>
                            <div>
                        ...
                        <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 pt-4">
                            <button 
                                type="submit" 
                                className="w-full py-2 md:py-3 bg-[#00A89F] text-white rounded-lg hover:bg-opacity-90 transition-colors"
                            >
                                Actualizar Alumno
                            </button>
                            <button 
                                ...
                                className="w-full py-2 md:py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors"
                            >
                                Cancelar
                            </button>
                        </div>
