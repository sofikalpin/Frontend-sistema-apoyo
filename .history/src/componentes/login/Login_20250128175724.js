          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  className="w-full p-3 mt-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
                  id="email"
                  type="email"
                  name="email"
              ...
              <div>
                ...
                {errors.contraseña && <span id="password-error" className="text-red-500 text-sm">{errors.contraseña}</span>}
              </div>
