...
const Mensajes = ({ usuarioId, chatId }) => {
    ...
    useEffect(() => {
        const obtenerUsuario = async () => {
            try {
                const response = await axios.get(`https://backend-sistema-apoyo-production.up.railway.app/API/Usuario/BuscarUsuario?idUsuario=${usuarioId}`);
    ...
    useEffect(() => {
        const cargarMensaje = async () => {
            setLoading(true);
            try {
                const response = await axios.get("https://backend-sistema-apoyo-production.up.railway.app/API/Mensaje/MensajeporChatID", {
    ...
    const handleEnviarMensaje = async () => {
        ...
        try {
            const response = await axios.post("https://backend-sistema-apoyo-production.up.railway.app/API/Mensaje/EnviarMensaje", datosMensaje);
            setMensajes((prevMensajes) => {
